<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团地址" prop="shetuandizhi">
          <el-input v-model="ruleForm.shetuandizhi" 
              placeholder="社团地址" clearable  :readonly="ro.shetuandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团地址" prop="shetuandizhi">
              <el-input v-model="ruleForm.shetuandizhi" 
                placeholder="社团地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团电话" prop="shetuandianhua">
          <el-input v-model="ruleForm.shetuandianhua" 
              placeholder="社团电话" clearable  :readonly="ro.shetuandianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团电话" prop="shetuandianhua">
              <el-input v-model="ruleForm.shetuandianhua" 
                placeholder="社团电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.shetuandizhi!=''&&json.shetuandizhi){
                this.ruleForm.shetuandizhi = json.shetuandizhi
	    		this.ro.shetuandizhi = true;
		}
		...
		if(json.shetuandianhua!=''&&json.shetuandianhua){
                this.ruleForm.shetuandianhua = json.shetuandianhua
	    		this.ro.shetuandianhua = true;
		}
        } else {
	...
	this.ruleForm.shetuanjieshao = this.ruleForm.shetuanjieshao.replace(reg,'../../../ssmpl93x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
