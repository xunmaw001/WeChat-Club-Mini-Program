  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shetuan'"  label="社团地址" prop="shetuandizhi">
          <el-input v-model="ruleForm.shetuandizhi"               placeholder="社团地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shetuan'"  label="社团电话" prop="shetuandianhua">
          <el-input v-model="ruleForm.shetuandianhua"               placeholder="社团电话" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'shetuan' ==this.flag && this.ruleForm.shetuandianhua&&(!isMobile(this.ruleForm.shetuandianhua))){
